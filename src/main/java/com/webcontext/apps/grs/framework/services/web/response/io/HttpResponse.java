...
public abstract class HttpResponse<T> implements IHttpResponse {
	 ...
	 * 
	 * @see
	 * com.webcontext.apps.grs.framework.services.web.http.IHttpResponse#getEncodage
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.webcontext.apps.grs.framework.services.web.http.IHttpResponse#getMimeType
	 * ()
	 */
	@Override
