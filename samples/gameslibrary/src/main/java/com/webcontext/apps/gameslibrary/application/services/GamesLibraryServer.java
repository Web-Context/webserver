...
import com.webcontext.apps.gameslibrary.application.services.GamesLibraryServer;
 ...
 * 
 */
public class GamesLibraryServer {

	private static Logger LOGGER = Logger.getLogger(GamesLibraryServer.class);
